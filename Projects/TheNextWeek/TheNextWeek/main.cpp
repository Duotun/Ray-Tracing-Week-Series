...
hittable_list final_scene() {
    ...
    auto ground = make_shared<lambertian>(color(0.48, 0.83, 0.53));  //green ground
    ...
    */
    ...
    objects.add(boundary); //blue sphere from earth map
...
hittable_list cornell_smoke() {
    ...
    //auto emat = make_shared<lambertian>(make_shared<image_texture>("../../earthmap.jpg"));
    //objects.add(make_shared<Sphere>(60, point3(300, 200, 300), emat));

    auto boundary = make_shared<Sphere>(5000, point3(260, 260, 260), make_shared<dielectric>(1.5));
    objects.add(make_shared<constant_medium>(boundary, .0001, color(1, 1, 1)));
...
{
    hittable_list objects;
    auto scolor = make_shared<noise_texture>(4);
...
int main()
{
    ...
    case 5:
        ...
        world = simple_light();
        samples_per_pixel = 400;    // simple light + perlin
